...
screen new_investigationboard():
    ...
    # GLASS SHARDS
    imagebutton:
        idle Transform("glass_shards.png", zoom=0.14, rotate=5)
        hover Transform("glass_shards.png", zoom=0.19, rotate=5)
        xpos 290 # left - decrease; right - increase
        ypos 140 # taas - decrease; baba - increase
        action NullAction()

    # WATCH
    imagebutton:
        idle Transform("watch.png", zoom=0.14, rotate=4)
        hover Transform("watch.png", zoom=0.19, rotate=4)
        xpos 330 # left - decrease; right - increase
        ypos 340 # taas - decrease; baba - increase
        action NullAction()
    
    # EARRINGS
    imagebutton:
        idle Transform("earring.png", zoom=0.11, rotate=-3)
        hover Transform("earring.png", zoom=0.17, rotate=-3)
        xpos 280 # left - decrease; right - increase
        ypos 300 # taas - decrease; baba - increase
        action NullAction()
